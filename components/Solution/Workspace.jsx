      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Deliver fast service</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Boost agent productivity</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Simplify ticket workflows</h3>
            <p className="text-gray-600 leading-relaxed">
