        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#05444B] leading-tight">
              AI-powered <span className="text-[#7ED957]">ticketing system</span>
            </h1>
            ...
            <div className="pt-4">
              <button className="inline-flex items-center gap-3 bg-[#7ED957] text-[#05444B] font-semibold px-6 py-3 rounded-lg hover:bg-[#6bc24b] transition-colors duration-200 shadow-lg">
          ...
          <div className="relative">
            ...
            {/* Floating chat icon */}
            <div className="absolute -bottom-4 -right-4 bg-[#05444B] text-white p-3 rounded-full shadow-lg">
